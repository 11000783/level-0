...
public class CallTheMethod {
	...
	//double area = calculateAreaOfACirle(8);
	//System.out.println(area);
	//*. Call the drawASquare method
		//drawASquare(12,13,4,18);
		...
		//*. Call the reverseString method and print the results to the screen
		 //String reverse = reverseString("I'm Cool da ba dee da ba daa da ba dee da ba daa da ba dee da ba dooo");  
